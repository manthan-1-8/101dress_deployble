      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          <div className={`transition-all duration-1000 ${
            ...
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-foreground font-light leading-tight mb-8">
              Where luxury finds 
            ...
            <div className="mt-10">
              <a 
                href="#story" 
                className="nav-link text-foreground text-nav inline-block"
              >
                Read Our Story
              </a>
            </div>
        ...
        {/* Stats Row */}
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 mt-24 pt-16 border-t border-border transition-all duration-1000 delay-500 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
          {[
